...
// COMMENT: Let's not bother with iter.
// /**
...
// COMMENT: No config, just use the default malloc and free.
// /**
...
// COMMENT: Not too interesting, keep it short and simple
// enum cc_stat  cc_slist_splice_at       (CC_SList *list1, CC_SList *list2, size_t index);

// COMMENT: Ignore, alias for cc_slist_add_last
// enum cc_stat  cc_slist_add             (CC_SList *list, void *element);
enum cc_stat  cc_slist_add_at          (CC_SList *list, void *element, size_t index);

// COMMENT: Removed, because requires link_all_externally, which is non-trivial -- they'll
//          probably want to move on quickly from this file
