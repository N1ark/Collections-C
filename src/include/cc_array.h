...
// COMMENT: irrelevant if we remove configuration!
...
// COMMENT: Just an alias for cc_array_remove_at size-1
...
// COMMENT: just an alias for cc_array_get_at size-1
...
// COMMENT: requires qsort
// void          cc_array_sort            (CC_Array *ar, int (*cmp) (const void*, const void*));

// COMMENT: Gillian can't do/reason about function pointers
